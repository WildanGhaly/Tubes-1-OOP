...
#include "Function/InsideArray.hpp"
...
int main(){
    ...
    do {
        ...
        if (path == 1){
            ...
            for (int i = 0; i < cards.getTotalCard(); i++)
            {
                            ...
                            while(!valid){
                                ...
                                if (playeropt == "Double"){
                                    ...
                                    if (playeropt == "QUADRUPLE"){
                                        ...
                                        //         activity.push_back(temp_actv);
                                        //     }else{
                                        //         quadruple.printPesan2(playeropt);
                                        //         valid = false;
                                        //     }
                                        // }else{
                                        //     quadruple.printPesan(playeropt);
                                        //     valid = false;
                                        // }
